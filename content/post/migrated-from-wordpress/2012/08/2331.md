...
Mods can address many of those foibles, but as I determined previously, Civ 5's mechanics are nuanced and elaborate enough that re-setting the balance on everything can be more trouble than it's worth.  What would be perfect would be if the bevy of options in a mod like <a href="https://steamcommunity.com/sharedfiles/filedetails/?id=78295051">Vanilla Enhanced</a> could be configured individually, or split into different mods, so I could "fix" the things that annoy me about Civ 5 without adding a whole bunch of other stuff.  But, alas.
