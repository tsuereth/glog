...
It's plainly evident from spending even a few minutes with Other M that this isn't a full-blooded Nintendo game.  Nintendo first-parties absolutely can't release a game until it's polished to a blinding sheen, even if it means a [shallow general experience](game:Wii Play).  Other M, on the other hand, is a risky proposition: the ambitious storytelling, <i>voice acting</i>, and franchise-changing action gameplay make it unlike any game Nintendo would ever make on its own.  The result is, well, imperfect, and could very well be <a href="https://www.destructoid.com/review-metroid-other-m/">underwhelming</a> depending on your expectations.
