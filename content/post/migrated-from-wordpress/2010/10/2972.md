...
If there is a single redeeming thing about <a href="https://en.wikipedia.org/wiki/Java_(programming_language)">Java</a>, it's Minecraft.
...
As for crafting, there is an item-crafting system (which is how you get the aforementioned torches, picks, and shovels) but that's not what I mean -- that system could use some work, I think, since the crafting materials are impossible to know unless you just <a href="https://minecraft.fandom.com/wiki/Crafting">google it</a>.  No, the crafting I like is more like <i>LEGO</i>.  Whatever you dig up, you can use as a building material.  Hence, <i>castle</i>.  The <a href="https://minecraft.fandom.com/wiki/Redstone_circuits">more advanced stuff</a> is pretty well beyond what I want to put into a game, but, come on.  Castle!  Awesome.
